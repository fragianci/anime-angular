...
import { DynamicTruncateDirective } from './directives/dynamic-truncate.directive';
...
const DIRECTIVES = [UnlessDirective, CustomShadowDirective, DynamicTruncateDirective];
